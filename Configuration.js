...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperatura, mientras que el segundo es un sensor de dióxido de carbono.
    ...
    endpoints.addEndpoint("1", "Sensor nivel resinas 1", endpointType.weightSensor);
    endpoints.addEndpoint("2", "Sensor nivel resinas 2", endpointType.weightSensor);
    endpoints.addEndpoint("3", "Sensor nivel resinas 3", endpointType.weightSensor);
    endpoints.addEndpoint("4", "Sensor nivel resinas 4", endpointType.weightSensor);
