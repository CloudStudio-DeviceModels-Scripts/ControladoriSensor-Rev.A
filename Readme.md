...
# Parsing + Configuration Script – ControladoriSensor - Rev. A

This **Parsing + Configuration** script is designed for the **ControladoriSensor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ControladoriSensor Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ControladoriSensor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
